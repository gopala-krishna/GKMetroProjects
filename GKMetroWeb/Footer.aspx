...
<html xmlns="http://www.w3.org/1999/xhtml">
 <div class="bg-black">
                ...
                <div class="grid no-margin">
                    <div class="row no-margin">
                        ...
                        <div class="span4 padding10">
                            ...
                            <a class="icon-location on-right on-left" href ="" style="background: yellow;color: white; padding: 10px; border-radius: 50%"></a>
                            <a class="icon-skype on-right on-left" href ="" style="background: skyblue;color: white; padding: 10px; border-radius: 50%"></a>

                        </div>

                     
                         <div class="span6 padding5">
                                    <p class="fg-white">Contact me if you need professional advice on</p>
                            </div>
                        <div class="span3 padding10">
            ...
            <div class="container tertiary-text bg-black fg-white" style="padding: 10px">
                <footer>
                    <div class="bottom-menu-wrapper fg-white" >
                        <ul class="horizontal-menu compact fg-white">
                            <li>&copy; 2014 Gopala Krishna</li>
